...
public class StudentUtil {
	...
	public static double[] calculateGPA(int[] studentIdList, char[][] studentsGrades)
			throws MissingGradeException,IllegalArgumentException {
		...
		if (studentIdList.length != studentsGrades.length) {
			throw new IllegalArgumentException("studentIdList & studentsGrades are out-of-sync. studnetIdList.length: "
	...
	public static void main(String[] args) throws Exception {
		...
		char studentsGrades[][] = { { 'A', 'B', 'C', 'B' }, { 'A', 'C', ' ', 'C' } };
