...
public class CarPriceEstimator {
	...
	public double getSalePrice(String makeAndModel, int yearManufactured, double milesDriven, 
		...
		if(ageOfCar<=10) {
			 salePrice=salePrice*(1-ageOfCar*0.05);
		}
		else {
				 salePrice *= 0.1;
		}
		...
		if(10000<additionalMiles && additionalMiles <=30000 ) {
			salePrice-=1000;
		}
	...
	public static void main(String[] args) {
		...
		double salesPrice = carPriceEstimator.getSalePrice("ford ecosport", 2019, 5000.0, 5, true, true, true, false, false, false);		
	}
}
